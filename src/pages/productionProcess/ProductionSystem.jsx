...
const ProductionSystem = () => {
    ...
    const handleProduce = async () => {
        if (!selectedNorma || quantityToProduce <= 0 || !selectedMarket) {
            toast.warning('Iltimos, mahsulot turi va miqdorini tanlang', { toastId: 'invalid-input' });
            return;
        }
        try {
                ...
                >
                    <div className="history-header-section">
                        <div className="history-title-container">
                            ...
                            <div>
                                ...
                                <p className="header-description">Xom ashyo va tayyor mahsulotlarni boshqaring</p>
                            </div>
                        </div>
                    </div>
                    <div className="space-y-8">
                        <div className="production-card">
                                        ...
                                        ?.materials?.map((req, index) => (
                                            <div key={index} className="material-item">
                                                ...
                                                <span className="material-quantity">
                                                    {req.quantity * quantityToProduce} {req.materialId.unit}
                                                </span>
                                            </div>
                            ...
                            <button
                                disabled={!selectedNorma || quantityToProduce <= 0 || normasLoading || productionLoading}
                ...
                >
                    <div className="history-header-section">
                        <div className="history-title-container">
                            ...
                            <div>
                                <h2 className="header-title">Ruberoid Ishlab Chiqarish Tarixi</h2>
                                <p className="header-description">Barcha ishlab chiqarish jarayonlari ro'yxati </p>
                            </div>
                        </div>
                    </div>
                    <div className="history-card">
                            ...
                            {historyLoading ? (
                                                    ...
                                                    <div className="materials-section">
                                                        <div className="materials-header">
                                                            <button
                                                                ...
                                                                onClick={() => setSelectedMaterials(entry.materialsUsed)}
                                                            >
                                ...
                                <div className="empty-state">
                                    ...
                                    <div className="empty-content">
                                        <h3 className="empty-title">Hozircha ishlab chiqarish tarixi yo'q</h3>
                        ...
                        {/* Materials Modal */}
                        {selectedMaterials && (
                            <div className="modal-overlay" onClick={() => setSelectedMaterials(null)}>
                                <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                                    <div className="modal-header">
                                        <div className="modal-title-section">
                                            <div className="modal-icon">🧱</div>
                                            <div>
                                                <h3 className="modal-title">Ishlatilgan Xom Ashyolar</h3>
                                                <p className="modal-subtitle">Ushbu partiya uchun sarflangan materiallar</p>
                                            </div>
                                        </div>
                                        <button
                                                ...
                                                <div key={idx} className="modal-material-card">
                                                    <div className="material-card-header">
                                                        ...
                                                        <div className="material-card-info">
                                                            <h4 className="material-card-name">{material.materialName}</h4>
                                                            <p className="material-card-category">Xom ashyo</p>
                                                        </div>
                                                    </div>
                                                    <div className="material-card-quantity">
                                                        <span className="quantity-number">{material.quantityUsed}</span>
                                                        <span className="quantity-unit">{material.unit || 'dona'}</span>
                                                    </div>
                                                    <div className="material-card-progress">
                                                        <div className="progress-bar">
                                                            <div
                                                                ...
                                                                style={{
                                                                    width: `${Math.min((material.quantityUsed / 100) * 100, 100)}%`,
                                    ...
                                    <div className="modal-footer">
                                        <div className="modal-stats">
                                            <div className="stat-box">
                                                <span className="stat-value">{selectedMaterials.length}</span>
                                                <span className="stat-label">Jami material turi</span>
                                            </div>
                                            <div className="stat-box">
                                                <span className="stat-value">
                                                    {selectedMaterials.reduce((sum, m) => sum + m.quantityUsed, 0)}
                                                </span>
