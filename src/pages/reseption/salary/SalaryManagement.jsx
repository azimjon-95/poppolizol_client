              ...
              <div className="factory-modal-body">
                <div className="factory-form-group">
                  ...
                  <input
                    ...
                    value={formatNumber(paymentForm.amount)}
                    onChange={(e) => {
                    ...
                    <div className="factory-payment-method-grid">
                      {Object.entries(paymentMethods).map(([key, value]) => (
                        <div className="factory-payment-method-option" key={key}>
                          ...
                          />
                          <label htmlFor={`payment-${key}`} className="factory-payment-method-label">
                            {value}
                          </label>
                        </div>
                      ))}
                    ...
                    <div className="factory-payment-method-grid">
                      {Object.entries(salaryMethods).map(([key, value]) => (
                        <div className="factory-payment-method-option" key={key}>
                          ...
                          />
                          <label htmlFor={`salary-${key}`} className="factory-payment-method-label">
                            {value}
                          </label>
                        </div>
                      ))}
...
//   const [showPaymentModal, setShowPaymentModal] = useState(false);
//   const [showPenaltyModal, setShowPenaltyModal] = useState(false);
//   const [showPaymentHistoryModal, setShowPaymentHistoryModal] = useState(false); // New state for payment history modal
//   const [selectedEmployee, setSelectedEmployee] = useState(null);
//   const { searchQuery } = useSelector((state) => state.search);
//   const [alert, setAlert] = useState(null);
//   const navigate = useNavigate();
...
//   const summary = calculateSummary();
//   const uniqueRoles = [...new Set(filteredEmployees.map(emp => emp.role))];

//   // Agar select option formatida qaytarish kerak bo‘lsa:
...
//               options={roleOptions}
//               onChange={(value) => {
//                 const filteredByRole = filteredEmployees.filter(emp => emp.role === value);
//                 console.log("Tanlangan role:", value);
//               }}
//             />
//           </div>
