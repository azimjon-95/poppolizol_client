    ...
    <div className="sacod-sales-container">
      ...
      <div className="sacod-navigation">
        <div className="sacod-filter-controls">
          <button
            className={`sacod-nav-btn ${
              activeTab === "products" ? "sacod-nav-btn-active" : ""
            }`}
          ...
          <button
            className={`sacod-nav-btn ${
              activeTab === "cart" ? "sacod-nav-btn-active" : ""
            }`}
          ...
          <button
            className={`sacod-nav-btn ${
              activeTab === "sales" ? "sacod-nav-btn-active" : ""
            }`}
          ...
          {role !== "saler" && (
            <button
              className={`sacod-nav-btn ${
                activeTab === "salespeople" ? "sacod-nav-btn-active" : ""
              }`}
      ...
      {activeTab === "products" && (
        <div className="sacod-products-grid">
          {finishedProducts?.map((product, inx) => (
            <div
              key={inx}
              className={`sacod-product-card ${
                product.isReturned ? "sacod-product-card-returned" : ""
              }`}
            >
              {product.isReturned && (
