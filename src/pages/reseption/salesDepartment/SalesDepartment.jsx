...
import { Package, FileText, User, ShoppingCart, Factory, Info } from 'lucide-react';
...
const SacodSalesModule = () => {
    ...
    return (
        <div className="sacod-sales-container">
            ...
            <div className="sacod-navigation">
                ...
                </div>
                {
                    ...
                    role === "saler_meneger" || role === "saler"
                        ?
                        <button className="profile-btn about-log" ref={searchPanelRef} onClick={showLogoutModal}>
                            <RiUser3Line />
                        </button>
                        :
                        <></>
                    ...
                    {finishedProducts?.map((product, inx) => (
                        ...
                        >
                            ...
                            <div className="sacod-product-header">
                                <div className="sacod-product-icon">{getProductIcon(product.type)}</div>
            ...
            {activeTab === 'cart' && <CartTab setActiveTab={setActiveTab} cart={cart} setCart={setCart} />}
                                ...
                                {contractInfo.customerType === 'company' && (
                                    <div className="sacod-form-row">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setContractInfo({ ...contractInfo, customerCompanyAddress: e.target.value })
                                            }
                                            className="sacod-form-input"
                                        />
                                        <input
                                ...
                                {cart?.map((item) => (
                                    <div key={item.id} className="sacod-cart-item">
                                        <div className="sacod-cart-item-info">
                                            ...
                                            <p>
                                                Asl narx: {(item.type === 'coal_paper' ? item.pricePerUnit : item.pricePerKg)?.toLocaleString()}{' '}
                            ...
                            <div className="sacod-form-section">
                                ...
                                <div className="sacod-form-row">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setContractInfo({ ...contractInfo, paymentAmount: Number(e.target.value) })
                                        }
                                        className="sacod-form-input"
                                        min="0"
                                    />
                                ...
                                <div className="sacod-form-row">
                                    ...
                                    <p>
                                        {selectedReturnInfo?.returnDate
                                            ? new Date(selectedReturnInfo.returnDate).toLocaleDateString('uz-UZ')
                                            : 'N/A'}
                                    </p>
                                </div>
                                <div className="sacod-form-row">
